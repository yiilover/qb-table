...
E_D("replace into `qb_vote_element` values('71','10','谷歌粉丝团','2','0','vote/1_20090317160317_NO50S.gif','我是谷歌粉丝团','http://www.google.cn');");
...
E_D("replace into `qb_vote_element` values('73','11','CN域名白菜到猪肉','2','10','vote/1_20090419090455_L5Iz8.jpg','','http://www.admin5.com/article/20081231/124093.shtml');");
...
E_D("replace into `qb_vote_element` values('75','11','番茄花园被告','2','6','vote/1_20090419090445_qQiaW.jpg','','http://www.admin5.com/article/20081231/124093.shtml');");
...
E_D("replace into `qb_vote_element` values('82','12','中电云集','11','0','vote/1_20101109161100_eooqn.jpg','','http://www.chinaccnet.com/');");
E_D("replace into `qb_vote_element` values('83','12','华夏名网','11','0','vote/1_20101109161103_nulvn.jpg','','http://www.sudu.cn/');");
E_D("replace into `qb_vote_element` values('84','12','群英网络','11','0','vote/1_20101109161108_q5bre.jpg','','http://www.qy.com.cn/');");
E_D("replace into `qb_vote_element` values('85','12','371数据','12','0','vote/1_20101109161112_omvjo.jpg','','http://www.371.com/');");
E_D("replace into `qb_vote_element` values('86','12','中网互联','11','0','vote/1_20101109161116_zlkqh.jpg','','http://www.zwidc.com/');");
E_D("replace into `qb_vote_element` values('87','12','星辉互联','11','0','vote/1_20101109161120_ylaj7.jpg','','http://www.eydns.com/');");
