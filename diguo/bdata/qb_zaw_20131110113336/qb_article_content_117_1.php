...
DoSetDbChar('gbk');
E_D("DROP TABLE IF EXISTS `qb_article_content_117`;");
E_C("CREATE TABLE `qb_article_content_117` (
...
E_D("replace into `qb_article_content_117` values('1','726','790','74','1','51130','8130','150','190','31','1','115','150','1200','1700','1.7');");
