...
E_D("replace into `qb_moneylog` values('219','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=68&aid=720'' target=_blank>NU1020</A>','1383831642');");
E_D("replace into `qb_moneylog` values('221','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=70&aid=722'' target=_blank>81220</A>','1383833621');");
E_D("replace into `qb_moneylog` values('223','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=72&aid=724'' target=_blank>61820</A>','1383835730');");
E_D("replace into `qb_moneylog` values('225','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=74&aid=726'' target=_blank>51130</A>','1383837374');");
E_D("replace into `qb_moneylog` values('119','1','-1','文章被删除扣分:','1378538585');");
E_D("replace into `qb_moneylog` values('227','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=76&aid=728'' target=_blank>135TN9</A>','1383838129');");
...
E_D("replace into `qb_moneylog` values('220','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=69&aid=721'' target=_blank>352218</A>','1383832809');");
E_D("replace into `qb_moneylog` values('222','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=71&aid=723'' target=_blank>7661</A>','1383834106');");
E_D("replace into `qb_moneylog` values('224','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=73&aid=725'' target=_blank>71930C</A>','1383836189');");
E_D("replace into `qb_moneylog` values('226','1','1','发表文章通过审核奖分<A HREF=''http://www1.ddecshop.com/bencandy.php?fid=75&aid=727'' target=_blank>135TN9</A>','1383837861');");
