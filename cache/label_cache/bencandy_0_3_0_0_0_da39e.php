...
$label['show_right_top_picad']=stripslashes('<SCRIPT LANGUAGE=\'JavaScript\' src=\'http://www1.ddecshop.com/do/a_d_s.php?job=js&ad_id=show_right_top_picad\'></SCRIPT>');
$label['show_topad']=stripslashes('<SCRIPT LANGUAGE=\'JavaScript\' src=\'http://www1.ddecshop.com/do/a_d_s.php?job=js&ad_id=show_topad\'></SCRIPT>');
$label['article_show']=stripslashes('<SCRIPT LANGUAGE=\'JavaScript\' src=\'http://www1.ddecshop.com/do/a_d_s.php?job=js&ad_id=article_show\'></SCRIPT>');
$label['article_show_tag']=stripslashes('广告位');
$label['view_article_bbs_tag']=stripslashes('论坛推荐图文');
?>