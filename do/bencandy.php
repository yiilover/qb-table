...
//文章自定义模型
if($fidDB[fmid]>0) $rsdb2 = get_module_content2('article_content_'.$fidDB[fmid],$aid,$fidDB[fmid]);
$benTPL=html("bencandy_$fidDB[fmid]");
...
$tableTPL=html("bencandy_tpl/table_{$rsdb[mid]}");
